...
confirmed_cases = train_input['newmaleconfcase'].tolist()
search_freq = train_input['malesearch'].tolist()
confirmed5_cases = train_input['newmale5'].tolist()
...
confirmed_cases_test = test_input['newmaleconfcase'].tolist()
search_freq_test = test_input['malesearch'].tolist()
confirmed5_cases_test = test_input['newmale5'].tolist()
